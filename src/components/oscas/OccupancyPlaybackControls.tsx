...
import {selectConnectedObservables} from "../../state/Slice";
import {TimePeriod} from "../../data/Models";
...
const OccupancyPlaybackControls = (props: IPlaybackTimeControlsProps) => {

    // let masterTime: IMasterTime = useAppSelector<IMasterTime>(selectMasterTime);
    let playbackSpeed: number = 1;
    let playbackState: PlaybackState = PlaybackState.PAUSE;
        ...
        <Table style={{alignContent: "center", margin: "0em 1em 0em 1em"}}>
            <TableBody>
                <TableRow>
                    ...
                    <TableCell>
                        {TimePeriod.getFormattedTime(props.currentTime)}
                    </TableCell>
                    <TableCell>
                        End Time:
                    </TableCell>
...
export default OccupancyPlaybackControls;