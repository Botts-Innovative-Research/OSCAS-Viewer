...
const OccupancyView = (props: IOccupancyProps)=> {
    ...
    useEffect(()=>{
        ...
        //@ts-ignore
        // masterTimeController.addDataSource(rpmGammaDataSource);
        ...
        //@ts-ignore
        // masterTimeController.addDataSource(rpmNeutronDataSource);
        ...
        //@ts-ignore
        // masterTimeController.addDataSource(rpmVideoDataSource);
    ...
    return (
        <div>
            <div>
                ...
                {/*    zIndex: '10'*/}
                {/*}}>*/}
                {/*    /!*<OccupancyTimeController dataSync={masterTimeController} occupancy={props.occupancy}/>*!/*/}
                {/*</div>*/}
            </div>
            <CountTable name={props.name} datasource={props.datasource}/>
        </div>
